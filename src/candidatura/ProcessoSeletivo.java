...
public class ProcessoSeletivo {
    public static void main(String[] args) {
        ...
        double[] salariosPretendidos = {1400.0, 2200.0, 2000.0};
        for (double salarioPretendido : salariosPretendidos) {
    ...
    static void entrandoEmContato(String candidato) {
        ...
        if (!atendeu) {
            System.out.println("NÃO conseguimos o contato com " + candidato + " após " + tentativasRealizadas + " tentativas!");
        }
    }
}